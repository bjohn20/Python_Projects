...
class ParentWindow(Frame):
    def __init__(self,master):
        ...
        self.sourceDir_btn.grid(row=0, column=0, padx=(30, 10), pady=(30, 0))

        # Creates entry for source directory selection
        self.source_dir = Entry(width=75)
        # Positions entry in GUI using tkinter grid() padx andpady are the same as
